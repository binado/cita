...
use bibi_bibliography::{parse as parse_bibtex, project_bibtex};
use bibi_core::{Locator, MetadataProvider, ProviderError, Reference, ReferenceSource};
...
const DEFAULT_USER_AGENT: &str = concat!("bibi-inspire-client/", env!("CARGO_PKG_VERSION"));
